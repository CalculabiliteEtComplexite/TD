...
\begin{exercice}[Langages miroir et copie]\label{exo:languages/chomsky/copy}
  ...
  \begin{correction}
    ...
    B\alpha &\rightarrow& AX \rightarrow \alpha X \rightarrow \alpha B\\
    B\beta  &\rightarrow& AY \rightarrow \beta Y \rightarrow \beta B\\
    BC      &\rightarrow& AZ \rightarrow CZ \rightarrow Cb\\
    C      &\rightarrow& c\\
    \alpha &\rightarrow& a\\
    \beta  &\rightarrow& b\\
    \end{array}\right\}  \right\rangle$
